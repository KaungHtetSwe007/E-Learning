...
<div class="wrapper">
	<div class="tabs_container">
		<div class="tabs_header">
			<h1>Html & CSS Advance သင်ခန်းစာများ</h1>
			<ul>
    ...
    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 ">
      <div class="card mb-4">
        ...
        <div class="bottom-text pt-2">
          ...
          <div class="watch"> <a href="https://youtu.be/XhqEuyWjbdo" class="btn-w" rel="prettyPhoto"><i class="fad fa-play"></i> ကြည့်ရန်</a> <a href="#" class="share"><i class="fad fa-share-alt"></i></a> </div>
        </div>
      </div>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 ">
      <div class="card mb-4">
        ...
        <div class="top-text pt-2">
          <div class="title">
             <h3>HTML Advance ဗီဒီယိုများ</h3>
          </div>
        ...
        <div class="bottom-text pt-2">
          ...
          <div class="watch"> <a href="https://youtu.be/GE2qnXC8UMg" class="btn-w" rel="prettyPhoto"><i class="fad fa-play"></i> ကြည့်ရန်</a> <a href="#" class="share"><i class="fad fa-share-alt"></i></a> </div>
        </div>
      </div>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 ">
      <div class="card mb-4">
        ...
        <div class="bottom-text pt-2">
          ...
          <div class="watch"> <a href="https://youtu.be/D-h8L5hgW-w" class="btn-w" rel="prettyPhoto"><i class="fad fa-play"></i> ကြည့်ရန်</a> <a href="#" class="share"><i class="fad fa-share-alt"></i></a> </div>
        </div>
      </div>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 ">
      <div class="card mb-4">
        ...
        <div class="bottom-text pt-2">
          ...
          <div class="watch"> <a href="https://youtu.be/uCdliQCk4lE" class="btn-w" rel="prettyPhoto"><i class="fad fa-play"></i> ကြည့်ရန်</a> <a href="#" class="share"><i class="fad fa-share-alt"></i></a> </div>
        </div>
      </div>
    </div>
  </div>
