...
<div class="wrapper">
	<div class="tabs_container">
		<div class="tabs_header">
			<h1>Html & CSS Intermidiate သင်ခန်းစာများ</h1>
			<ul>
        ...
        <li>
          <span class="icon"><i class="fas fa-calendar-week"></i></span>
          <span class="item"><a style="text-decoration: none; color: white;" href="htmlcss.php">ပင်မစာမျက်နှာ</a></span>
        </li>
			</ul>
		</div>
    ...
    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 ">
      <div class="card mb-4">
        ...
        <div class="top-text pt-2">
          <div class="title">
            <h3>HTML CSS Intermidiate ဗီဒီယိုများ</h3>
          </div>
        ...
        <div class="bottom-text pt-2">
          ...
          <p><span>HTML</span> <span>CSS</span> <span>Javascript</span></p>
          <div class="watch"> <a href="https://youtu.be/kyj9zSrUZB4?list=RDkyj9zSrUZB4" class="btn-w" rel="prettyPhoto"><i class="fad fa-play"></i> ကြည့်ရန်</a> <a href="#" class="share"><i class="fad fa-share-alt"></i></a> </div>
        </div>
      </div>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 ">
      <div class="card mb-4">
        ...
        <div class="top-text pt-2">
          <div class="title">
            <h3>HTML Intermidiate ဗီဒီယိုများ</h3>
          </div>
        </div>
        <div class="bottom-text pt-2">
          <div class="title">
          ...
          <div class="watch"> <a href="https://www.youtube.com/watch?v=8eX-GHwd6ds" class="btn-w" rel="prettyPhoto"><i class="fad fa-play"></i> ကြည့်ရန်</a> <a href="#" class="share"><i class="fad fa-share-alt"></i></a> </div>
        </div>
      </div>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 ">
      <div class="card mb-4">
        ...
        <div class="bottom-text pt-2">
          ...
          <div class="watch"> <a href="https://www.youtube.com/watch?v=Lo_6bp6ApvE" class="btn-w" rel="prettyPhoto"><i class="fad fa-play"></i> ကြည့်ရန်</a> <a href="#" class="share"><i class="fad fa-share-alt"></i></a> </div>
        </div>
      </div>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 ">
      <div class="card mb-4">
        ...
        <div class="bottom-text pt-2">
          ...
          <div class="watch"> <a href="https://www.youtube.com/watch?v=Y0REQPbxrV4" class="btn-w" rel="prettyPhoto"><i class="fad fa-play"></i> ကြည့်ရန်</a> <a href="#" class="share"><i class="fad fa-share-alt"></i></a> </div>
        </div>
      </div>
    </div>
  </div>
