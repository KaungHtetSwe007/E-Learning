...
<nav>
  ...
  <ul class="nav_list" id="nav_menu">
    ...
    <li class="hideOnMobile"><a href="home.php" class="nav_link"  style=" margin-left:100px;">ပင်မစာမျက်နှာ</a></li>

    <li class="hideOnMobile"><a href="usercontactus.php" class="nav_link">ဆက်သွယ်ရန်</a></li>
    <li class="hideOnMobile"><a href="#" class="nav_link">ဝက်ဘ်ဆိုဒ်အကြောင်း</a></li>
  ...
  <ul>
    ...
    <div class="bann">
        <div class="column1">
            <h1 style="color: #3586ff;">JavaScript သင်ခန်းစာများ</h1>
            <p>Contact us for Javascript</p>
            <button>ချိတ်ဆက်ရန်</button>
        </div>
        <div class="column2">
            <img src="img/remote-meeting-animate.svg" alt="" width="500px">
        </div>
    </div>
    ...
    <div class="container">
        <div class="card" style="background-color: #7ccef7 ;">
            <div class="imageBx">
                <img src="img/javascriptBeginner.jpg" alt="">
            </div>
            <div class="content">
                <div>
                    <h3>Level-1</h3>
                    <p>Level for Beginners.</p>
                    <button class="btn" style="margin-top: 40px;"><a href="javascriptbasic.php">ပိုမိုလေ့လာရန်</a>
                    </button>
                </div>
            </div>
        </div>
        <div class="card" style="background-color: #7ccef7 ;">
            <div class="imageBx">
                <img src="img/javascriptIntermediate.jpg" alt="">
            </div>
            <div class="content">
                <div>
                    <h3>Level-2</h3>
                    ...
                    <button class="btn" style="margin-top: 25px;"><a href="javascriptintermidiate.php">ပိုမိုလေ့လာရန်</a>
                    </button>
                </div>
            </div>
        </div>
        <div class="card" style="background-color: #7ccef7 ;">
            <div class="imageBx">
                <img src="img/javascriptAdvance.jpg" alt="">
            </div>
            <div class="content">
                <div>
                    <h3>Level-3</h3>
                    ...
                    <button class="btn" style="margin-top: 40px;"><a href="javascriptadvance.php">ပိုမိုလေ့လာရန်</a>
                    </button>
