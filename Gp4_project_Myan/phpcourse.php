  ...
  <ul>
    ...
    <div class="bann">
        <div class="column1">
            ...
            <p>PHP Programming တွင် ကျွမ်းကျင်သူများဖြစ်ရမည်။</p>
        ...
        <div class="card" style="background-color: #7ccef7;">
            ...
            <div class="content">
                <div>
                    ...
                    <button class="btn" style="margin-top: 40px;"><a href="phpbasic.php">ပိုမိုလေ့လာရန်</a>
                    </button>
                </div>
            </div>
        </div>
        <div class="card" style="background-color: #7ccef7;">
            ...
            <div class="content">
                <div>
                    ...
                    <button class="btn" style="margin-top: 25px;"><a href="phpintermidiate.php">ပိုမိုလေ့လာရန်</a>
                    </button>
                </div>
            </div>
        </div>
        <div class="card" style="background-color: #7ccef7;">
            ...
            <div class="content">
                <div>
                    ...
                    <button class="btn" style="margin-top: 40px;"><a href="phpadvance.php">ပိုမိုလေ့လာရန်</a>
                    </button>
                </div>
            </div>
        </div>
