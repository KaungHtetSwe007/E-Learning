...
<div class="header">
      <div class="container">
        <div class="container__left" id="ll">
          <h1>Read what our customers love about us</h1>
          <p>
            Our mission is to provide a one-stop, free, non-profit way to learn computer science.
          </p>
          <p>
            Go ahead with your programming journey with full strength.
          </p>
          <p>Take steps to achieve your goals.</p>
          ...
          <div class="popup_form" >
            ...
            <div class="modal__container" id="modal-container">
                <div class="modal__content">
                    ...
                    <h1 class="modal__title">Share Your Thoughts</h1>
