...
$conn=mysqli_connect("localhost","root","","gp4_project");
	...
	if (isset($_POST['submit'])) {
		...
		$s="SELECT * FROM account WHERE username='$fname' AND email='$mail'";
		...
		<?php
			...
			?>
			<script type="text/javascript">
				alert("You can't contact to us. If your data worng,you change your data.If you don't have account,please sign up.");
