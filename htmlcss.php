...
<nav>
  ...
  <li class="hideOnMobile"> <a href="review.php"class="nav_link">Reviews</a></li>
  ...
  <ul>
    ...
    <div class="bann">
        <div class="column1">
            <h1 style="color: #3586ff;">Html & Css Course</h1>
            <p>Contact us for Html.Css</p>
           <button><a href="Login_signup.php">JOIN</a></button>
        </div>
        <div class="column2">
            <img src="img/html-animate.svg" alt="" width="500px">
        </div>
    </div>
        ...
        <div class="card" style="background-color: #7ccef7;">
            ...
            <div class="content">
                <div>
                    ...
                    <button class="btn" style="margin-top: 40px;"><a href="htmlbasic.php">More</a>
                    </button>
                </div>
            </div>
        </div>
        <div class="card" style="background-color: #7ccef7;">
            ...
            <div class="content">
                <div>
                    ...
                    <button class="btn" style="margin-top: 25px;"><a href="htmlintermidiate.php">More</a>
                    </button>
                </div>
            </div>
        </div>
        <div class="card" style="background-color: #7ccef7;">
            ...
            <div class="content">
                <div>
                    ...
                    <button class="btn" style="margin-top: 40px;"><a href="htmladvance.php">More</a>
                    </button>
