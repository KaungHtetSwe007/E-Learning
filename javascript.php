...
<nav>
  ...
  <ul>
    ...
    <div class="bann">
        <div class="column1">
            <h1 style="color: #3586ff;">JavaScript Course</h1>
        ...
        <div class="card" style="background-color: #7ccef7 ;">
            ...
            <div class="content">
                <div>
                    ...
                    <button class="btn" style="margin-top: 40px;"><a href="javascriptbasic.php">More</a>
                    </button>
                </div>
            </div>
        </div>
        <div class="card" style="background-color: #7ccef7 ;">
            ...
            <div class="content">
                <div>
                    ...
                    <button class="btn" style="margin-top: 25px;"><a href="javascriptintermidiate.php">More</a>
                    </button>
                </div>
            </div>
        </div>
        <div class="card" style="background-color: #7ccef7 ;">
            ...
            <div class="content">
                <div>
                    ...
                    <button class="btn" style="margin-top: 40px;"><a href="javascriptadvance.php">More</a>
                    </button>
