...
<div class="wrapper">
  ...
  <div class="row">
    ...
    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 ">
      <div class="card mb-4">
        <div class="img"> <img src="https://cdn.pixabay.com/photo/2023/02/09/18/42/podcast-7779510_1280.png"> </div>
        ...
        <div class="bottom-text pt-2">
          ...
          <div class="watch"> <a href="https://youtu.be/OK_JCtrrv-c" class="btn-w" rel="prettyPhoto"><i class="fad fa-play"></i> Watch</a> <a href="#" class="share"><i class="fad fa-share-alt"></i></a> </div>
        </div>
      </div>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 ">
      <div class="card mb-4">
        <div class="img"> <img src="https://cdn.pixabay.com/photo/2016/09/21/11/31/youtube-1684601_1280.png"> </div>
        <div class="top-text pt-2">
          <div class="title">
            <h3>PHP Advance</h3>
          </div>
        ...
        <div class="bottom-text pt-2">
          ...
          <div class="watch"> <a href="https://youtu.be/2pflogLDDeo" class="btn-w" rel="prettyPhoto"><i class="fad fa-play"></i> Watch</a> <a href="#" class="share"><i class="fad fa-share-alt"></i></a> </div>
        </div>
      </div>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 ">
      <div class="card mb-4">
        <div class="img"> <img src="https://cdn.pixabay.com/photo/2020/06/06/22/00/online-5268393_1280.png"> </div>
        <div class="top-text pt-2">
          <div class="title">
            <h3>PHP Advance</h3>
          </div>
        ...
        <div class="bottom-text pt-2">
          ...
          <div class="watch"> <a href="https://youtu.be/qxZthRY_cN8" class="btn-w" rel="prettyPhoto"><i class="fad fa-play"></i> Watch</a> <a href="#" class="share"><i class="fad fa-share-alt"></i></a> </div>
        </div>
      </div>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 ">
      <div class="card mb-4">
        <div class="img"> <img src="https://cdn.pixabay.com/photo/2016/08/20/06/09/video-1606945_1280.png"> </div>
        <div class="top-text pt-2">
          <div class="title">
            <h3>PHP Advance</h3>
          </div>
        ...
        <div class="bottom-text pt-2">
          ...
          <div class="watch"> <a href="https://youtu.be/dam0GPOAvVI" class="btn-w" rel="prettyPhoto"><i class="fad fa-play"></i> Watch</a> <a href="#" class="share"><i class="fad fa-share-alt"></i></a> </div>
        </div>
      </div>
    </div>
  </div>
