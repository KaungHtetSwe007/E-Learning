...
<div class="wrapper">
 ...
 <div id="cc">
          <center><h3 style="color: #3586ff;">If you want to study, you can download files at there.</h3></center>
    			...
    			$query2 = "SELECT * FROM files WHERE type='phpintermediate'";
    			$run2 = mysqli_query($conn,$query2);           
    			while($rows = mysqli_fetch_assoc($run2)){
    		?>
					<div class="pcard" style="--clr:#009688">
						<div class="imgBx">
							<img src="https://cdn.pixabay.com/photo/2015/09/16/09/47/books-942485_960_720.jpg">
						</div>
						<div class="content">
  ...
  <div class="row">
    ...
    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 ">
      <div class="card mb-4">
        <div class="img"> <img src="https://cdn.pixabay.com/photo/2017/03/25/04/00/youtube-2172750_1280.png"> </div>
    ...
    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 ">
      <div class="card mb-4">
        <div class="img"> <img src="https://cdn.pixabay.com/photo/2019/09/15/21/51/youtube-4479480_1280.jpg"> </div>
        <div class="top-text pt-2">
          <div class="title">
           <h3>PHP</h3>
          </div>
        ...
        <div class="bottom-text pt-2">
          ...
          <div class="watch"> <a href="https://youtu.be/5OdVJbNCSso" class="btn-w" rel="prettyPhoto"><i class="fad fa-play"></i> Watch</a> <a href="#" class="share"><i class="fad fa-share-alt"></i></a> </div>
        </div>
      </div>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 ">
      <div class="card mb-4">
        <div class="img"> <img src="https://cdn.pixabay.com/photo/2017/06/30/03/34/gui-2457115_1280.png"> </div>
        <div class="top-text pt-2">
          <div class="title">
            <h3>PHP</h3>
          </div>
    ...
    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 ">
      <div class="card mb-4">
        <div class="img"> <img src="https://cdn.pixabay.com/photo/2014/04/05/09/30/tablet-314153_1280.png"> </div>
        <div class="top-text pt-2">
          <div class="title">
            <h3>PHP</h3>
          </div>
        ...
        <div class="bottom-text pt-2">
          ...
          <div class="watch"> <a href="https://youtu.be/zZ6vybT1HQs" class="btn-w" rel="prettyPhoto"><i class="fad fa-play"></i> Watch</a> <a href="#" class="share"><i class="fad fa-share-alt"></i></a> </div>
        </div>
      </div>
    </div>
  </div>
